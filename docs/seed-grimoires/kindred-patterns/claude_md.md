# CLAUDE.md — Behavioural guidelines used to build Kindred

These are the rules the Kindred team held itself to while building the
system across 7 plans. They are here so readers can audit them and so
newcomers can adopt them.
